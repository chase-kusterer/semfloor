...
urlpatterns = [
    ...
    path("g/<str:code>/setup/keywords/edit/", views.setup_keyword_edit, name="setup_keyword_edit"),
    path("g/<str:code>/setup/keywords/import/", views.setup_keywords_import, name="setup_keywords_import"),
    path("g/<str:code>/setup/keywords/export.csv", views.setup_keywords_export, name="setup_keywords_export"),
